...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// <summary>
        /// <para>
        ///     This Method traverses the dependency graph to find and record
        ///     all of the dependent children of A cell that has been changed. 
        ///     It is passed
        ///     <list type="bullet">
        ///         <item>The name of the Cell this traversal started at</item>
        ///         <item>The name of the Cell the Traversal is currently on.</item>
        ///         <item>A record of the cells already seen in this traveral</item>
        ///         <item>A record of the cells affected by this change</item>
        ///         
        ///     </list>
        /// <para>
        ///     As soon as the traversal arrives at a cell, it records it as visited in its set.
        ///     If a Cell has any dependents (Cells that refer to it in their formulas) the traversal checks
        ///     that they are not the first cell that we visited, or else it throws a CirularException
        ///     to show that the dependencies are circular and cannot be computed. If the cell has
        ///     not been added to the visited set, then the method steps to that cell and starts
        ///     from the top of the algorithm.
        /// </para>
        /// <para>
        ///     Once there are no depenents of the dependents left, the adds the current cell to the list
        ///     of cells affected by the change and steps back to the previous cell, adding it as well.
        ///     This moves all the way back to the top of the call stack and the first cell changed.
        /// </para>
        /// </summary>
        /// <exception cref="CircularException">Throws if the dependencies come full circle to start.</exception>
        /// <param name="changed">A list of changed cells, in order of their position in the dependencies.</param>
        /// <param name="name">The cell being visited and checked for any changes to its children</param>
        /// <param name="start">The first cell in the chain of dependencies.</param>
        /// <param name="visited">A set of the cells that have been seen in the traversal. Forces the list of changed
        ///                         To not have any duplicates.</param>
        /// 
